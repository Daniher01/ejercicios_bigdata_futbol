...
generar_score_csv(posicion_target_ = c("CD"), nombre_archivo = "ejercicios/score_players/data_score/modelo1/score_CD.csv")
generar_score_csv(posicion_target_ = c("RD", "LD"), nombre_archivo = "ejercicios/score_players/data_score/modelo1/score_RD_LD.csv")
generar_score_csv(posicion_target_ = c("DM"), nombre_archivo = "ejercicios/score_players/data_score/modelo1/score_DM.csv")
generar_score_csv(posicion_target_ = c("CM"), nombre_archivo = "ejercicios/score_players/data_score/modelo1/score_CM.csv")
generar_score_csv(posicion_target_ = c("LM", "RM"), nombre_archivo = "ejercicios/score_players/data_score/modelo1/score_RM_LM.csv")
generar_score_csv(posicion_target_ = c("F"), nombre_archivo = "ejercicios/score_players/data_score/modelo1/score_F.csv")
